...
%x and y values
x_acetone = linspace(0,1,10);
x_ethanol = linspace(0,1,10);
x_ethyl = linspace(0,1,10);
T_vap = [298];
T_liq = [298];
...
figure()
ternpcolor(x_ace, x_eth, x_yl,T_liq);
shading interp
ternlabel('x_A_c_e_t_o_n_e', 'x_E_t_h_a_n_o_l', 'x_E_t_h_y_l_ _A_c_e_t_a_t_e')
title('Bubble Points for Acetone/Ethanol/Ethyl Acetate Mixtures')
figure()
ternpcolor(x_ace, x_eth, x_yl,T_vap);
shading interp
ternlabel('x_A_c_e_t_o_n_e', 'x_E_t_h_a_n_o_l', 'x_E_t_h_y_l_ _A_c_e_t_a_t_e')
title('Dew Points for Acetone/Ethanol/Ethyl Acetate Mixtures')

figure()
ternsurf(x_ace,x_eth,x_yl,((T_liq-329.418)./(342.322-329.418)))
shading interp
%axis([0 1 0 1 0 1])
legend('(T-329.418)/(430.586-329.418)')
...
% figure()
% ternsurf(x_eth,x_ace,((T_liq-329.418)./(430.586-329.418)))
% shading interp
% %axis([0 1 0 1])
% legend('(T-329.418)/(430.586-329.418)')
...
% 
% figure()
% ternsurf(1-x_ace-x_eth,x_eth,((T_liq-329.418)./(430.586-329.418)))
% shading interp
% %axis([0 1 0 1])
% legend('(T-329.418)/(430.586-329.418)')
...
% 
% figure()
% ternsurf(1-x_ace-x_eth,x_ace,((T_liq-329.418)./(430.586-329.418)))
% shading interp
% %axis([0 1 0 1])
% legend('(T-329.418)/(430.586-329.418)')
...
% 
% figure()
% ternsurf(x_ace,1-x_ace-x_eth,((T_liq-329.418)./(430.586-329.418)))
% shading interp
% %axis([0 1 0 1])
% legend('(T-329.418)/(430.586-329.418)')
...
% 
% figure()
% ternsurf(x_eth,1-x_ace-x_eth,((T_liq-329.418)./(430.586-329.418)))
% shading interp
% %axis([0 1 0 1])
% legend('(T-329.418)/(430.586-329.418)')
