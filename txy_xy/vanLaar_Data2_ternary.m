...
%Van laar parameters
A12 = 0.8786; %acetone,ethanol
A21 = 1.2771; %ethanol,acetone
...
% 
% figure()
% ternsurf(x_ace,x_eth,((T_liq-329.418)./(438.499-329.418)))
% shading interp
% %axis([0 1 0 1 0 1])
% legend('(T-329.418)/(438.499-329.418)')
...
% 
% figure()
% ternsurf(x_eth,x_ace,((T_liq-329.418)./(438.499-329.418)))
% shading interp
% %axis([0 1 0 1])
% legend('(T-329.418)/(438.499-329.418)')
...
% 
% figure()
% ternsurf(1-x_ace-x_eth,x_eth,((T_liq-329.418)./(438.499-329.418)))
% shading interp
% %axis([0 1 0 1])
% legend('(T-329.418)/(438.499-329.418)')
...
% 
% figure()
% ternsurf(1-x_ace-x_eth,x_ace,((T_liq-329.418)./(438.499-329.418)))
% shading interp
% %axis([0 1 0 1])
% legend('(T-329.418)/(438.499-329.418)')
...
% 
% figure()
% ternsurf(x_ace,1-x_ace-x_eth,((T_liq-329.418)./(438.499-329.418)))
% shading interp
% %axis([0 1 0 1])
% legend('(T-329.418)/(438.499-329.418)')
...
% 
% figure()
% ternsurf(x_eth,1-x_ace-x_eth,((T_liq-329.418)./(438.499-329.418)))
% shading interp
% %axis([0 1 0 1])
% legend('(T-329.418)/(438.499-329.418)')
