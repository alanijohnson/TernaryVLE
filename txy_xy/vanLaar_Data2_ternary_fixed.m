...
figure()
ternsurf(x_ace,x_eth,x_yl,((T_liq-329.418)./(351.4410-329.418)))
shading interp
%axis([0 1 0 1 0 1])
...
figure()
ternsurf(x_eth,x_ace,((T_liq-329.418)./(351.4410-329.418)))
shading interp
%axis([0 1 0 1])
legend('(T-329.418)/(351.4410-329.418)')
...
figure()
ternsurf(1-x_ace-x_eth,x_eth,((T_liq-329.418)./(351.4410-329.418)))
shading interp
%axis([0 1 0 1])
legend('(T-329.418)/(351.4410-329.418)')
...
figure()
ternsurf(1-x_ace-x_eth,x_ace,((T_liq-329.418)./(351.4410-329.418)))
shading interp
%axis([0 1 0 1])
legend('(T-329.418)/(351.4410-329.418)')
...
figure()
ternsurf(x_ace,1-x_ace-x_eth,((T_liq-329.418)./(351.4410-329.418)))
shading interp
%axis([0 1 0 1])
legend('(T-329.418)/(351.4410-329.418)')
...
figure()
ternsurf(x_eth,1-x_ace-x_eth,((T_liq-329.418)./(351.4410-329.418)))
shading interp
%axis([0 1 0 1])
legend('(T-329.418)/(351.4410-329.418)')
