...
% 
figure()
ternplot(A_y_ace105,A_y_eth95,A_y_ey105,'r.','MarkerSize',2)
hold on
ternplot(A_y_ace95,A_y_eth95,A_y_ey95,'r.','MarkerSize',2)
hold on
ternplot(A_y_ace,A_y_eth,A_y_ey,'b.','MarkerSize',10)

ternlabel('Acetone', 'Ethanol', 'Ethyl Acetate')
%title('Acetone K=1 in Acetone/Ethanol/Ethyl Acetate Mixture')
legend('K=1.05','K=0.95','K=1')
set(gca,'FontSize',14)
% 
% % array2table(B_y_ace')
% % array2table(B_y_eth')
...
% 
figure()
ternplot(B_y_ace105,B_y_eth105,B_y_ey105,'r.','MarkerSize',2)
hold on
ternplot(B_y_ace95,B_y_eth95,B_y_ey95,'r.','MarkerSize',2)
hold on
ternplot(B_y_ace,B_y_eth,B_y_ey,'b.','MarkerSize',10)
ternlabel('Acetone', 'Ethanol', 'Ethyl Acetate')
...
% %Ethyl Acetate K=1
figure()
ternplot(C_y_ace105,C_y_eth105,C_y_ey105,'r.','MarkerSize',2)
hold on
ternplot(C_y_ace95,C_y_eth95,C_y_ey95,'r.','MarkerSize',2)
hold on
ternplot(C_y_ace,C_y_eth,C_y_ey,'b.','MarkerSize',10)
ternlabel('Acetone', 'Ethanol', 'Ethyl Acetate')
...
% %All on one plot
figure()
ternplot(A_y_ace,A_y_eth,1-A_y_ace-A_y_eth,'r.','MarkerSize',10)
hold on
ternplot(B_y_ace,B_y_eth,1-B_y_ace-B_y_eth,'g.','MarkerSize',10)
hold on
ternplot(C_y_ace,C_y_eth,1-C_y_ace-C_y_eth,'b.','MarkerSize',10)
ternlabel('Acetone', 'Ethanol', 'Ethyl Acetate')
legend('K=1 Acetone', 'K=1 Ethanol', 'K=1 Ethyl Acetate')
%title('K=1 for components in Acetone/Ethanol/Ethyl Acetate Mixture')
legend('Acetone','Ethanol','Ethyl Acetate')
 set(gca,'FontSize',14)
