...
r(1) = text(0.5, -0.07, A, 'horizontalalignment', 'center','FontSize',14);
r(2) = text(1-0.35*sin(deg2rad(30)), 0.5, B, 'rotation', -60, 'horizontalalignment', 'center','FontSize',14);
r(3) = text(0.35*sin(deg2rad(30)), 0.5, C, 'rotation', 60, 'horizontalalignment', 'center','FontSize',14);
