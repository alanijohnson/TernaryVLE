...
%x and y values
x_acetone = linspace(0.5,1,100);
x_ethanol = linspace(0.5,1,100);
x_ethyl = linspace(0.5,1,100);
T_vap = [298];
T_liq = [298];
...
figure()
ternsurf(x_ace,x_eth,((T_liq-329)./(351.4410-329.418)))
shading interp
%axis([0 1 0 1])
...
figure()
ternsurf(x_eth,x_ace,((T_liq-329)./(351.4410-329.418)))
shading interp
%axis([0 1 0 1])
legend('(T-329.418)/(352.26-329.418)')
ternlabel2('x_E_t_h_a_n_o_l','x_A_c_e_t_o_n_e',  'x_E_t_h_y_l_ _A_c_e_t_a_t_e')
title('Temperature Surface Contour for Acetone/Ethanol/Ethyl Acetate Mixture')

figure()
ternsurf(1-x_ace-x_eth,x_eth,((T_liq-329)./(351.4410-329.418)))
shading interp
%axis([0 1 0 1])
legend('(T-329.418)/(351.4410-329.418)')
ternlabel('x_E_t_h_y_l_ _A_c_e_t_a_t_e','x_E_t_h_a_n_o_l','x_A_c_e_t_o_n_e' )
title('Temperature Surface Contour for Acetone/Ethanol/Ethyl Acetate Mixture')
